    ...
    <>
      ...
      <header className="header">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <a href="https://max.app/phone/79856008537" target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "36px", height: "36px", borderRadius: "50%", background: "var(--primary)", color: "white", textDecoration: "none", fontSize: "16px" }}>💬</a>
        ...
        <div onClick={() => setShowContacts(false)} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.4)", zIndex: 999, display: "flex", alignItems: "center", justifyContent: "center" }}>
          <div onClick={e => e.stopPropagation()} style={{ background: "white", borderRadius: "20px", padding: "36px 40px", maxWidth: "360px", width: "90%", textAlign: "center", boxShadow: "0 8px 40px rgba(0,0,0,0.18)" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px", marginTop: "20px" }}>
              <a href="https://max.app/phone/79856008537" target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", padding: "12px", borderRadius: "12px", background: "#25D366", color: "white", textDecoration: "none", fontWeight: 600, fontSize: "15px" }}>
                💬 WhatsApp
              </a>
        ...
        <section className="hero">
          <div className="hero-content">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-5">
              ...
              <a href="https://max.app/phone/79856008537" target="_blank" rel="noopener noreferrer" className="btn-cta" style={{ background: "#25D366", color: "white", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "8px" }}>
                💬 Написать нам
              </a>
            </div>
          </div>
